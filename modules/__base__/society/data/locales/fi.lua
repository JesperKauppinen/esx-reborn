...
Translations = {
  ...
  ['invalid_amount_max']     = 'palkan arvo ei sallittu',
  ['no']                     = 'ei',
  ['promote']                = 'muuta tasoa',
  ...
  ['yes']                    = 'kyllä',
  ['you_have']               = 'sinulla on ~g~€%s~s~ pestyä rahaa ~y~rahapesulassa~s~ (24h).',
  ...
  ['you_have_fired']         = 'sinä irtisanoit pelaajan %s',
  ['you_have_been_fired']    = 'sinulle irtisanottiin työstä %s',
  ['you_have_promoted']      = 'sinä muutit henkilön %s tasolle %s',
  ['you_have_been_promoted'] = 'sinun arvoasi muutettiin',
}
